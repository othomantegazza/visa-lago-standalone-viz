...
country_level_2022 %>% 
  ...
  write_csv('data/formatted/2022-country-level-clean.csv')
...
country_level_2023 %>% 
  ...
  #   fitted = .fitted
  # ) %>% 
  write_csv('data/formatted/2023-country-level-clean.csv')
...
country_level_2024 %>% 
  ...
  #   fitted = .fitted
  # ) %>% 
  write_csv('data/formatted/2024-country-level-clean.csv')
...
visa_uk_dec2024 <- 
  read_tsv('data/visaUK/UK-visas-summary-dec-2024-tables.tsv')
```
...
plot_uk_visa <- function(visa_uk, 
 ...
 visa_uk <- 
  ...
  grid.text(x = 0.76,
            ...
            gp = gpar(fontsize = 8),
            label = str_wrap(
              "Data from www.gov.uk, analysis and chart @LAGOCollective",
              width = 28),
            hjust = 0,
            vjust = 1)
  # dev.off()
...
#| fig-width: 10
#| fig-height: 9
plot_uk_visa(visa_uk_dec2024, year_ending = "December 2024",
             show_cost = F)
```
