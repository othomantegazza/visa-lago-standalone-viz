...
visa_2024 <- 
  read_and_clean_visa_stats(
    'data/visa/2024-schengen-visa-statistics-consulates_en.xlsx'
  )

visa_2023 <- 
  read_and_clean_visa_stats(
    'data/visa/2023-schengen-visa-statistics-consulates_en.xlsx.xlsx'
  )

visa_2022 <- 
  read_and_clean_visa_stats(
    'data/visa/Visa statistics for consulates in 2022_en.xlsx'
  )

visa_2019 <- 
  read_and_clean_visa_stats(
    'data/visa/2019-consulates-schengen-visa-stats.xlsx'
  )
```

```{r}
exempt <-
  read_csv('data/utils/short-stay-visa-exempt.csv') %>% 
...
eu_27 <- 
  read_csv('data/utils/eu-eurostat-codes.csv') %>% 
...
set.seed(1);plot_model(
  ...
  year = 2024,
  gdp_year = 2023,
  title = "Schengen Visa Rejection Rate in 2024"
)
```
